  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container ">
      ...
      ?>
        ...
        <div class="page3_PJ-title">

          <a href="detail.php?id=<?= $row["ID"] ?>"><i class="fa-solid fa-fw page3-fa-circle-left fa-circle-left"></i></a>
          &nbsp;&nbsp;
          <h2 class="mt-2">類別編輯頁面</h2>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <table class="table table-bordered table-striped page3_PJ-table">
              ...
              <tr>
                ...
                <td class="">
                  <textarea class="page3_PJ-text" rows="3" cols="100" name="brand"><?= trim($row["brand"]) ?></textarea>
                </td>
              </tr>
              <tr>
